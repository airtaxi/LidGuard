...
OpenCode 지원은 현재 OpenCode의 전역 plugin 방식을 사용합니다. LidGuard 보호를 시작하고, 입력 대기 상태를 표시하고, 작업 종료 시 보호를 정리할 수 있지만, OpenCode는 아직 절전 전 답장을 같은 종료 흐름으로 다시 넘기는 기능은 지원하지 않습니다.
