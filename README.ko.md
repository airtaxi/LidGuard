...
- 덮개를 닫은 상태에서 작업이 끝나려 할 때 절전 전 답장 알림을 보내고, 답장이 오면 작업을 이어갈 수 있습니다.
...
- 절전 전 답장 알림: 덮개를 닫은 상태에서 작업이 끝나려 할 때 "절전 전에 한 번 물어보기" 알림을 보낼 수 있습니다. 답장이 오면 작업을 이어가고, 기본 설정에서는 이어진 작업이 나중에 다시 끝나려 할 때 한 번 더 물어봅니다.
