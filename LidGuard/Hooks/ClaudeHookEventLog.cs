...
public static class ClaudeHookEventLog
{
    ...
    public static TimeSpan AppendReceived(ClaudeHookInput hookInput)
    {
        ...
        var details = HookEventLog.CreateDetails(("permissionMode", hookInput.PermissionMode), ("tool", hookInput.ToolName), ("toolUseId", hookInput.ToolUseIdentifier), ("agentId", hookInput.AgentIdentifier), ("agentType", hookInput.AgentType), ("taskId", hookInput.TaskIdentifier), ("reason", hookInput.Reason), ("notificationType", hookInput.NotificationType), ("isInterrupt", hookInput.IsInterrupt.ToString()), ("stopHookActive", hookInput.StopHookActive.ToString()));
    ...
    public static TimeSpan AppendRuntimeResult(ClaudeHookInput hookInput, string commandName, bool succeeded, bool runtimeUnavailable, int activeSessionCount, string message, string timingDetails = "")
    {
        ArgumentNullException.ThrowIfNull(hookInput);
