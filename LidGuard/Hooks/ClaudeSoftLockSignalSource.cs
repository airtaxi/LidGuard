...
public static class ClaudeSoftLockSignalSource
{
    ...
    private static bool IsResolutionNotificationType(string notificationType)
    {
        ...
        return normalizedNotificationType.Equals(ClaudeHookEventNames.ElicitationCompleteNotificationType, StringComparison.Ordinal) || normalizedNotificationType.Equals(ClaudeHookEventNames.ElicitationResponseNotificationType, StringComparison.Ordinal);
    }
}
