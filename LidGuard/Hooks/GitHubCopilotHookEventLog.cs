...
public static class GitHubCopilotHookEventLog
{
    ...
    private static bool IsUserPromptSubmittedEvent(string hookEventName) => string.Equals(hookEventName?.Trim(), GitHubCopilotHookEventNames.UserPromptSubmitted, StringComparison.Ordinal) || string.Equals(hookEventName?.Trim(), GitHubCopilotHookEventNames.PascalCaseUserPromptSubmittedAlias, StringComparison.Ordinal);
}
