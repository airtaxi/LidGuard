...
internal static class SettingsHelpContent
{
    ...
    private static IReadOnlyList<LidGuardHelpOption> CreateOptions(string supportedPostStopSuspendSystemSounds)
    {
        ...
        options.AddRange([
            ...
            new LidGuardHelpOption("--server-runtime-cleanup-delay-minutes off|<minutes>", "Set how long LidGuard stays running after all sessions end and cleanup is finished. Pass off to exit immediately. Minimum enabled value is 1."),
