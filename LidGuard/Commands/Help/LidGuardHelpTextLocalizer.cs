...
internal static class LidGuardHelpTextLocalizer
{
    private static readonly IReadOnlyDictionary<string, string> s_resourceNamesByNeutralText = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Optional. Defaults to settings-json. Also accepts json or hooks-json."] = "Help_ClaudeHooks_FormatOption",
        ...
        ["Optional. Defaults to config-toml. Also accepts toml or hooks-json."] = "Help_CodexHooks_FormatOption",
        ...
        ["Optional. Defaults to config-json. Also accepts json or hooks-json."] = "Help_CopilotHooks_FormatOption",
        ...
        ["Optional. Use default to follow the saved setting, or choose low, average, or high for this command only."] = "Help_CurrentTemperature_TemperatureModeOption",
        ...
        ["Required. Allowed values: Asterisk, Beep, Exclamation, Hand, or Question."] = "Help_PreviewSystemSound_NameOption",
        ...
        ["The saved suspend-history-count setting controls how many entries are retained. The --count option only limits how many retained entries are displayed."] = "Help_SuspendHistory_CountNote"
    };
