...
internal static class WslHookStatusHelpContent
{
    internal static LidGuardHelpCommandEntry Create(LidGuardHelpDocumentContext context)
        => WslHelpContentFactory.CreateHookManagementEntry(
            context,
...
{
    internal static LidGuardHelpCommandEntry Create(LidGuardHelpDocumentContext context)
        => WslHelpContentFactory.CreateHookSnippetEntry(
            context,
...
{
    internal static LidGuardHelpCommandEntry Create(LidGuardHelpDocumentContext context)
        => WslHelpContentFactory.CreateMcpManagementEntry(
            context,
...
{
    internal static LidGuardHelpCommandEntry Create(LidGuardHelpDocumentContext context)
        => WslHelpContentFactory.CreateProviderMcpEntry(
            context,
...
{
    internal static LidGuardHelpCommandEntry CreateHookManagementEntry(
        LidGuardHelpDocumentContext context,
        string commandName,
        string synopsisCommandName,
        string description)
    {
        return LidGuardHelpCommandEntryFactory.CreateSingleCommandEntry(
            ...
            $"{context.CommandDisplayName} {synopsisCommandName} [--provider codex|claude|copilot|all] [--config <path>] [--distro <name>]",
            description,
            [
    ...
    internal static LidGuardHelpCommandEntry CreateHookSnippetEntry(
        LidGuardHelpDocumentContext context,
        string commandName,
        string synopsisCommandName,
        ...
        string formatDescription)
    {
        return LidGuardHelpCommandEntryFactory.CreateSingleCommandEntry(
            ...
            [],
            LidGuardHelpSectionTitles.HookIntegration,
            $"{context.CommandDisplayName} {synopsisCommandName} {formatSynopsis} [--distro <name>]",
            description,
            [
                new LidGuardHelpOption("<format>", formatDescription),
                CreateDistroOption()
            ],
            CreateWslNotes());
    }

    internal static LidGuardHelpCommandEntry CreateMcpManagementEntry(
        LidGuardHelpDocumentContext context,
        string commandName,
        string synopsisCommandName,
        string description)
    {
        return LidGuardHelpCommandEntryFactory.CreateSingleCommandEntry(
            commandName,
            CreateProviderMcpAliases(synopsisCommandName),
            LidGuardHelpSectionTitles.McpIntegration,
            $"{context.CommandDisplayName} {synopsisCommandName} [codex|claude|copilot|all] [--distro <name>]",
            description,
            [
    ...
    internal static LidGuardHelpCommandEntry CreateProviderMcpEntry(
        LidGuardHelpDocumentContext context,
        string commandName,
        string synopsisCommandName,
        string argumentSynopsis,
        string description,
        bool includeProviderName)
    {
        ...
        return LidGuardHelpCommandEntryFactory.CreateSingleCommandEntry(
            ...
            [],
            LidGuardHelpSectionTitles.McpIntegration,
            $"{context.CommandDisplayName} {synopsisCommandName} {argumentSynopsis} [--distro <name>]",
            description,
            options,
            CreateWslNotes());
    }
