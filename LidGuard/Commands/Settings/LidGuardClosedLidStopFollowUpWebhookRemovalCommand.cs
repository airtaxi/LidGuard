...
internal static class LidGuardClosedLidStopFollowUpWebhookRemovalCommand
{
        ...
        ILidGuardRuntimePlatform runtimePlatform)
    {
        ...
        {
            Console.WriteLine(LocalizationService.GetString("SettingsNoClosedLidStopFollowUpWebhookConfigured", "설정된 closed-lid stop follow-up webhook이 없습니다."));
            return 0;
        }
        ...
        Console.WriteLine(LocalizationService.GetString("SettingsClosedLidStopFollowUpWebhookUrlRemoved", "closed-lid stop follow-up webhook URL을 제거했습니다."));
