...
internal sealed class LinuxCommandResult
{
    ...
    public static LinuxCommandResult Success(int exitCode, string standardOutput, string standardError) => new()
    {
        Started = true,
        ExitCode = exitCode,
    ...
    public static LinuxCommandResult Failure(string message, int exitCode = -1, string standardOutput = "", string standardError = "") => new()
    {
        Started = false,
        ExitCode = exitCode,
        StandardOutput = standardOutput ?? string.Empty,
