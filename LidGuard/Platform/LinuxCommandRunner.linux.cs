...
internal static class LinuxCommandRunner
{
    ...
    public static async Task<LinuxCommandResult> RunAsync(string fileName, IEnumerable<string> arguments, CancellationToken cancellationToken = default)
    {
        ...
        catch (Exception exception) when (exception is InvalidOperationException or System.ComponentModel.Win32Exception or FileNotFoundException) { return LinuxCommandResult.Failure($"Failed to start command {fileName}: {exception.Message}"); }
