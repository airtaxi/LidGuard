...
internal sealed class NotificationDatabaseInitializer(SqliteConnectionFactory connectionFactory)
{
    ...
    private static Task EnsureWebhookEventsColumnAsync(SqliteConnection connection, ISet<string> existingColumnNames, string columnName, string columnDefinition, CancellationToken cancellationToken) => EnsureColumnAsync(connection, existingColumnNames, "WebhookEvents", columnName, columnDefinition, cancellationToken);
