...
- `LidGuard.Notifications` owns webhook API endpoints, token login, subscription dashboard, webhook event history, ask-before-sleep reply/poll flows, SQLite persistence, Web Push sending, and background notification dispatch.
